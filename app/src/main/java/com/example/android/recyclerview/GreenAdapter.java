...
public class GreenAdapter extends RecyclerView.Adapter <GreenAdapter.NumberView Holder> {
...
public class GreenAdapter(int numbrOfItems) { mNumber Items=numberOfItems;
                                            }
    // TODO (5) Override the onCreateViewHolder method
    // TODO (6) Create and return a new NumberViewHolder within this method
@Override
    Public NumberViewHolder onCraeteViewHolder(viewGroup viewGroup,int view type) {
        Context context=viewGroup.getcontext();
        int layuotinflater inflater=layout Inflater.from(context);
        boolean shouldAttachToParentImmediately=false;
        view view=infater,inflate(layoutIdForlistItem,
                                  view Group.ShoulaAttochToParentImmediately);
...
@Override
    Public void onBinViewHolder(NumberViewHolder holder, int position){
